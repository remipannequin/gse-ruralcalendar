...
// Bellow is some code from gnome shell extension FRC@jcdubacq.dubacq.fr
...
class RuralCalendar {
    ...
    /**
     * Transform a number into a string in the roman numbering system.
     *
     * @param {int} n the year to format
     * @returns a string representing n in roman numbering
     */
    romanNumeral(n) {
...
class RuralCalendarTopMenu extends PanelMenu.Button {
    ...
    fetch_detail() {
        if (!this.detail_url) {
            // no detail provided for this day, hide detail panel
            this.detail_menu_item.hide();
        }
        this.detail_menu_item.show();
